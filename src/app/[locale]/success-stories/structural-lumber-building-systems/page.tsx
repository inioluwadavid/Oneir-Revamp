...
export async function generateMetadata({
  ...
  return {
    title: isEnglish ? "Structural Lumber & Engineered Building Systems | Success Stories" : "Bois de charpente et systèmes de construction | Histoires de succès",
...
export default async function StructuralLumberCaseStudy({ params }: CaseStudyPageProps) {
  const { locale: localeParam } = await params;
  const locale = localeParam as Locale;
  const t = getTranslations(locale);

  const caseStudy = t.caseStudies?.structuralLumberBuildingSystems as {
  ...
  const title = locale === "en" ? "Structural Lumber & Engineered Building Systems" : "Bois de charpente et systèmes de construction";
